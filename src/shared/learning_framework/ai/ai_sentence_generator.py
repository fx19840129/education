...
try:
    from clients.context7_zhipu_client import Context7ZhipuClient as ZhipuAIClient
except ImportError:
    try:
        from clients.zhipu_client import ZhipuAIClient
    except ImportError:
...
class AISentenceGenerator:
    ...
    def __init__(self, config_path: str = None):
        ...
        if ZhipuAIClient:
            try:
                # 直接使用Context7ZhipuClient，不需要配置文件路径
                self.ai_client = ZhipuAIClient("glm-4.5-flash")
